/**
 * ./opencode-agent - SDK→Domain Type Mappers
 *
 * Converts types from @opencode-ai/sdk to @shared domain types.
...
/**
 * SDK's tool.ids() returns string[], while the webview consumes ToolListItem[].
